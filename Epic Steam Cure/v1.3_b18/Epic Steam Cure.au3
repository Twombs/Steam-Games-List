...
Global $keep, $Legendary, $LEGfold, $legskip, $line, $lines, $link, $ListGUI, $logfle, $manner, $mode, $musicfld, $nocheck, $notes
Global $other, $pass, $path, $ping, $pos, $process, $read, $resfile, $result, $savpth, $shell, $split, $state, $SteamCMD,  $steamfold
Global $store, $tabs, $tera, $text, $thread, $timefile, $titfle, $title, $updates, $URL, $user, $user32, $userID, $val, $vdffile
Global $version, $what, $xmlfle
