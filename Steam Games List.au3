...
Func MainGUI()
	Local $Button_id, $Button_image, $Button_link, $Button_title, $Checkbox_link, $Group_list, $Input_id, $Input_image, $Input_link, $Input_title, $List_games
	Local $a, $exStyle, $height, $left, $ListGUI, $parent, $store, $style, $tabs, $top, $width
	$exStyle = -1
	$height = 480
	$left = -1
	$parent = 0
	...
	$Input_link = GUICtrlCreateInput("", 160, 425, 250, 20)
	$Checkbox_link = GUICtrlCreateCheckbox("Store", 415, 425, 45, 20)
